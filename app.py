...
from constants import (
    ACCENT, ANIM_TYPES, APP_AUTHOR, APP_TITLE, BG_APP, BG_CANVAS,
    BG_SECTION, BG_SIDEBAR, BORDER, CANVAS_H, CANVAS_W, GREEN,
    LINE_DASHES, PURPLE, RED, REFLECTION_AXES, SHAPES, TEXT_BRIGHT,
    TEXT_DIM, TRANSFORMS,
)
